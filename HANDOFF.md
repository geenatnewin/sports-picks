...
- [ ] **Not yet verified against a real AI call**: Session 8's prompt tightening, Session 9's MLB removal, Session 10's AI Parlay feature, Session 11's advisory-board lenses, Session 12's deepened advisory-board lenses, and Session 13's Draw No Bet market + sharp-analyst prompt rework all shipped on typecheck/build confidence only — Session 13 especially worth a real spot-check next time a knockout-stage match is live, to confirm the AI actually reaches for Draw No Bet appropriately instead of defaulting back to Moneyline out of habit.
